...
if ($_POST) {
    ...
    $oldpasswordquery = mysqli_query($connection, "select faculty_password from tbl_faculty where faculty_id='{$_SESSION['faculty_id']}'") or die(mysqli_error($connection));
    $oldpasswordfromdb = mysqli_fetch_array($oldpasswordquery);
    //Old Password Condition
    if ($oldpasswordfromdb['faculty_password'] == $opass) {
        ...
        if ($npass == $cpass) {
            ...
            if ($opass == $npass) {
                ...
                $updateq = mysqli_query($connection, "update tbl_faculty set faculty_password='{$npass}' where faculty_id='{$_SESSION['faculty_id']}'") or die(mysqli_error($connection));
                if ($updateq) {
            ...
            <div class="row">
                ...
                <div class="col-lg-5 col-md-6 col-sm-12">
                    ...
                    <ul class="breadcrumb float-md-right">
                        <li class="breadcrumb-item"><a href="index.html"><i class="zmdi zmdi-home"></i> GLS</a></li>
