...
if($_POST){
    ...
    $q = mysqli_query($connection, "insert into tbl_division (division_name) values('{$name}')") or die(mysqli_error($connection));
                ...
                <div class="card">
                    ...
                    <div class="body">
                        <div class="row clearfix">
                            ...
                            <div class="col-sm-12">
                                <div class="form-group">
                                    <input type="text" name="txt1" class="form-control" placeholder=" Division" required />
                                </div>
                            </div>
