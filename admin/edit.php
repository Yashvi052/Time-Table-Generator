...
$fetchq = mysqli_query($connection, "select * from tbl_student where student_id='{$id}'") or die(mysqli_error($connection));
...
if($_POST)
{
    ...
    mysqli_query($connection, "update tbl_student set student_name='{$name}',student_gender='{$gender}',student_photo='{$photo}',student_mobileno='{$phoneno}',student_address='{$address}',student_dob='{$dob}',student_email='{$email}',student_password='{$password}',student_department_id='{$departmentid}',student_sem_id='{$semid}',student_div_id='{$divid}' where student_id='{$_GET['eid']}'");
...
if($_POST){
    ...
    $q = mysqli_query($connection, "insert into tbl_student (student_name, student_gender, student_photo, student_mobileno, student_address, student_dob, student_email, student_password, student_department_id, student_sem_id, student_div_id) "
            . "values('{$name}','{$gender}','{$photo}','{$phoneno}','{$address}','{$dob}','{$email}','{$password}','{$departmentid}','{$semid}','{$divid}',)") 
                    ...
                    <div class="body">
                        <div class="row clearfix">
                            <div class="col-lg-6 col-md-12">
                                <div class="form-group">
                                    <input type="text" name="txt1" value="<?php echo $row['student_name']; ?>" class="form-control" placeholder=" Name " required />
                                </div>
                            </div>
                            <!--<div class="col-lg-6 col-md-12">
                                <div class="form-group">
                        ...
                        <div class="row clearfix">
                            <div class="col-lg-4 col-md-6 col-sm-12">
                                <div class="form-group">
                                    <input type="text" name="txt2"  value="<?php echo $row['student_mobileno']; ?>"  class="form-control" placeholder="Phone No." required />
                                </div>
                            </div>
                            <div class="col-lg-4 col-md-6 col-sm-12">
                                <div class="form-group">
                                    <input type="text" name="txt3" value="<?php echo $row['student_dob']; ?>" class="datetimepicker form-control" placeholder="Date of Birth" required />
                                </div>
                            </div>
                            <!--<div class="col-lg-4 col-md-6 col-sm-12">
                                <div class="form-group">
                            ...
                            <div class="col-lg-4 col-md-6 col-sm-12">                                
                                <select class="form-control show-tick" name="txt4" value="<?php echo $row['student_gender']; ?>" required />
                            ...
                            <div class="col-lg-4 col-md-6 col-sm-12">
                                <div class="form-group">
                                    <input type="text" name="txt5" value="<?php echo $row['student_department_id']; ?>" class="form-control" placeholder="Department ID " required />
                                </div>
                            </div>
                            <div class="col-lg-4 col-md-6 col-sm-12">
                                <div class="form-group">
                                    <input type="text" name="txt6" value="<?php echo $row['student_sem_id']; ?>" class="form-control" placeholder="Sem ID " required />
                                </div>
                            </div>
                            <div class="col-lg-4 col-md-6 col-sm-12">
                                <div class="form-group">
                                    <input type="text" name="txt7" value="<?php echo $row['student_div_id']; ?>" class="form-control" placeholder="Div ID " required />
                                </div>
                            </div>
                            <div class="col-lg-4 col-md-6 col-sm-12">
                                <div class="form-group">
                                    <input type="text" name="txt8" value="<?php echo $row['student_email']; ?>" class="form-control" placeholder="Enter Your Email" required />
                                </div>
                            </div>
                        </div>
                        <div class="row clearfix">
                            <div class="col-lg-12 col-md-12 col-sm-12">
                                <!--<form action="https://thememakker.com/" id="frmFileUpload" class="dropzone" method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="fallback">
                                        <input name="txt9" value="<?php echo $row['student_photo']; ?>" type="file" multiple required />
                                    </div>
                                </form>
                            </div>
                        </div>
                        <div class="row clearfix">                            
                            <div class="col-sm-12">
                                <div class="form-group">
                                    <textarea rows="3" name="txt10" value="<?php echo $row['student_address']; ?>" class="form-control no-resize" placeholder="Address" required /></textarea>
                                </div>
                            </div>
                            <div class="body">
                        <div class="row clearfix">
                            <div class="col-lg-6 col-md-12">
                                <div class="form-group">
                                    <input type="text" value="<?php echo $row['student_email']; ?>" class="form-control" placeholder="Email" required>
                                </div>
                            </div>
                            <!--<div class="col-lg-6 col-md-12">
                                <div class="form-group">
                            ...
                            <div class="col-lg-6 col-md-12">
                                <div class="form-group">
                                    <input type="text" name="txt11" value="<?php echo $row['student_password']; ?>" class="form-control" placeholder="Password" required />
                                </div>
                            </div>
                            <!--<div class="col-lg-6 col-md-12">
                                <div class="form-group">
