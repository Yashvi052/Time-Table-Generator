                        ...
                        <div class="body">
                            <div class="table-responsive">
                                <table class='table table-hover m-b-0'>
                                    ...
                                    //Delete Start
                                    if(isset($_GET['did'])){
                                        $q =  mysqli_query($connection, "delete from tbl_student where student_id='{$_GET['did']}'") or die(mysqli_error($connection));
                                            if($q){
...
ORDER BY `tbl_student`.`student_id` ASC;") or die(mysqli_error($connection));
                                    ...
                                    while($data = mysqli_fetch_array($q)){
                                        echo "<tr>";
                                        echo "<td><a href='{$data['student_photo']}'><img class='rounded' src='{$data['student_photo']}'></a></td>";
                                        ...
                                        //echo "<td>{$data['student_password']}</td>";
                                        echo "<td>{$data['department_name']}</td>";
                                        echo "<td>{$data['sem_name']}</td>";
                                        echo "<td>{$data['division_name']}</td>";
                                        echo "<td><a href='edit.php?eid={$data['student_id']}'>Edit</a> | <a href='student-list.php?did={$data['student_id']}'>Delete</a></td>";
                                        echo "</tr>";
                                    }
                                    ?>
                                    </tbody>
