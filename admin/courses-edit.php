...
$fetchq = mysqli_query($connection, "select * from tbl_subject where subject_id='{$id}'") or die(mysqli_error($connection));
$row = mysqli_fetch_array($fetchq);
if($_POST)
{
    $name = $_POST['txt1'];
    mysqli_query($connection, "update tbl_subject set subject_name='{$name}' where subject_id='{$_GET['eid']}'");
...
if($_POST){
    ...
    $q = mysqli_query($connection, "insert into tbl_subject (subject_name) values('{$name}')") or die(mysqli_error($connection));
    ...
    <div class="container-fluid">
        <div class="row clearfix">
            <div class="col-lg-12 col-md-12 col-sm-12">
                <div class="card">
                    <div class="header">
                        <h2><strong>Course </strong> Information </h2>
                        ...
                        <div class="row clearfix">
                            <div class="col-sm-12">
                                <div class="form-group">
                                    <input type="text" name="txt1" value="<?php echo $row['subject_name']; ?>" class="form-control" placeholder="Courses Name" required>
                                </div>
                            </div>
                            <!--<div class="col-lg-3 col-md-6 col-sm-12">
                                <div class="form-group">
                                    <input type="text" class="datetimepicker form-control" placeholder="Starts From" required>
                                </div>
                            </div>
                            <div class="col-lg-3 col-md-6 col-sm-12">
                                <div class="form-group">
                                    <input type="text" class="form-control" placeholder="Course Duration" required>
                                </div>
                            </div>                            
                            <div class="col-lg-3 col-md-6 col-sm-12">
                                <div class="form-group">
                                    <input type="number" class="form-control" placeholder="Course Fee" required>
                                </div>
                            </div>
                            <div class="col-lg-3 col-md-6 col-sm-12">
                                <div class="form-group">
                                    <input type="text" class="form-control" placeholder="Course Incharge" required>
                                </div>
                            </div>-->
                           <!-- <div class="col-lg-12 col-md-12 col-sm-12">
                            ...
                            <!--<div class="col-lg-4 col-md-12">
                                <select name="txt2" class="form-control show-tick">
                                    ...
                                    <option value="6">MSCIT</option>
                                </select>
                            </div>
                            <div class="col-lg-4 col-md-6 col-sm-12">
                                <div class="form-group">
                                    <input type="number" name="txt3" class="form-control" placeholder="Year" required>
                                </div>
                            </div>
                            <div class="col-lg-4 col-md-6 col-sm-12">
                                <div class="form-group">
                            ...
                            <div class="col-sm-12">
                                <div class="form-group">
                                    <textarea rows="4" name="txt4" class="form-control no-resize" placeholder="Course Description" required></textarea>
                                </div>
                            </div>-->
                            <div class="col-sm-12">
