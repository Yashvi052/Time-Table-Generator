...
if(isset($_POST['btn'])){
    ...
    $q = mysqli_query($connection, "insert into tbl_faculty (faculty_name, faculty_gender, faculty_mobile, faculty_dob, faculty_address, faculty_photo, faculty_email, faculty_password, faculty_designation, faculty_department_id) "
            . "values('{$name}','{$gender}','{$phoneno}','{$dob}','{$address}','{$fileuploadpath}','{$email}','{$password}','{$departmentid}','{$designation}')") 
				...
				<div class="card">
					...
					<div class="body">
                        ...
                        <div class="row clearfix">
                            ...
                            <div class="col-md-3 col-sm-12">                                
                                <select name="txt4" class="form-control show-tick" required />
                            ...
                            <div class="col-md-3 col-sm-12">
                                <div class="form-group">
                                    <!--<input type="text" name="txt5" class="form-control" placeholder="Department ID" required />-->
                                    <?php 
                            ...
                            <div class="col-md-4 col-sm-12">
                                <div class="form-group">
                                    <input type="text" name="txt2" class="form-control" placeholder="Phone" required />
                                </div>
                            </div>
                            <div class="col-md-4 col-sm-12">
                                <div class="form-group">
                            ...
                            <div class="col-md-4 col-sm-12">
                                <div class="form-group">
                                    <input type="text" name="txt6" class="form-control" placeholder="Designation" required />
                                </div>
                            </div>
                            ...
                            <div class="col-sm-12">
                                <div class="form-group">
                                    <textarea rows="4" name="txt10" class="form-control no-resize" placeholder="Address" required /></textarea>
                                </div>
                            </div>
                            <div class="col-md-6 col-sm-12">
                                <div class="form-group">
                                    <input type="text" name="txt11" class="form-control" placeholder="Password">
                                </div>
                            </div>
                            <div class="col-md-6 col-sm-12">
                                <div class="form-group">
