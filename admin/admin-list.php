                        ...
                        <div class="table-responsive">
                            <table class="table table-hover m-b-0">
                                ...
                                <tbody>
                                    ...
                                    //Delete Start
                                    if(isset($_GET['did'])){
                                        $q =  mysqli_query($connection, "delete from tbl_admin where admin_id='{$_GET['did']}'") or die(mysqli_error($connection));
                                            if($q){
                                    ...
                                    while($data = mysqli_fetch_array($q)){
                                        ...
                                        //echo "<td>{$data['student_gender']}</td>";
                                        //echo "<td>{$data['student_photo']}</td>";
                                        //echo "<td><a href='{$data['student_photo']}'><img style='height:150px;width:150px;' src='{$data['student_photo']}'></a></td>";
                                        //echo "<td>{$data['student_mobileno']}</td>";
                                        //echo "<td>{$data['student_address']}</td>";
                                        //echo "<td>{$data['student_dob']}</td>";
                                        //echo "<td>{$data['student_email']}</td>";
                                        echo "<td>{$data['admin_password']}</td>";
                                        //echo "<td>{$data['student_department_id']}</td>";
                                        //echo "<td>{$data['student_sem_id']}</td>";
                                        //echo "<td>{$data['student_div_id']}</td>";
                                        echo "<td><a href='edit.php?eid={$data['admin_id']}'>Edit</a> | <a href='admin-list.php?did={$data['admin_id']}'>Delete</a></td>";
                                        echo "</tr>";
