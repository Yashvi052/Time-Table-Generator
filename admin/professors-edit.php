...
$fetchq = mysqli_query($connection, "select * from tbl_faculty where faculty_id='{$id}'") or die(mysqli_error($connection));
...
if($_POST)
{
    ...
    $designation = $_POST['txt6']; 
    $email = $_POST['txt8'];
    $photo = $_POST['txt9'];
    $address = $_POST['txt10'];
    $password = $_POST['txt11'];
    mysqli_query($connection, "update tbl_student set faculty_name='{$name}',faculty_gender='{$gender}',faculty_dob='{$dob}',faculty_mobileno='{$phoneno}',faculty_address='{$address}',faculty_department_id='{$departmentid}',faculty_designation='{$designation}',faculty_email='{$email}',faculty_photo='{$photo}',faculty_password='{$password}' where faculty_id='{$_GET['eid']}'");

    
    header("location:professors-list.php");
    }
?>
...
<!-- Mirrored from thememakker.com/templates/oreo/university/html/add-professors.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 27 Dec 2021 05:01:28 GMT -->
<head>
<meta charset="utf-8">
...
if($_POST){
    ...
    $q = mysqli_query($connection, "insert into tbl_faculty (faculty_name, faculty_gender, faculty_mobile, faculty_dob, faculty_address, faculty_photo, faculty_email, faculty_password, faculty_designation, faculty_department_id) "
            . "values('{$name}','{$gender}','{$phoneno}',{$dob}','{$address}','{$photo}',{$email}','{$password}','{$departmentid}','{$designation}')") 
    ...
    <div class="container-fluid">
        <div class="row clearfix">
			<div class="col-lg-12 col-md-12 col-sm-12">
				<div class="card">
					<div class="header">
						<h2><strong>Professors</strong> Information </h2>
					...
					<div class="body">
                        <div class="row clearfix">
                            <div class="col-md-6 col-sm-12">
                                <div class="form-group">
                                    <input type="text" name="txt1" value="<?php echo $row['faculty_name']; ?>" class="form-control" placeholder=" Name " required />
                                </div>
                            </div>
                            <!--div class="col-md-6 col-sm-12">
                                <div class="form-group">
                        ...
                        <div class="row clearfix">
                            <div class="col-md-3 col-sm-12">
                                <div class="form-group">
                                    <input type="text" name="txt3" value="<?php echo $row['faculty_dob']; ?>" class="datetimepicker form-control" placeholder="Date of Birth" required />
                                </div>
                            </div>
                            <div class="col-md-3 col-sm-12">                                
                                <select name="txt4" value="<?php echo $row['faculty_gender']; ?>" class="form-control show-tick" required />
                            ...
                            <div class="col-md-3 col-sm-12">
                                <div class="form-group">
                                    <input type="text" name="txt5" value="<?php echo $row['faculty_department_id']; ?>" class="form-control" placeholder="Department ID" required />
                                </div>
                            </div>
                            <!--<div class="col-md-3 col-sm-12">
                                <div class="form-group">
                            ...
                            <div class="col-md-4 col-sm-12">
                                <div class="form-group">
                                    <input type="text" name="txt2" value="<?php echo $row['faculty_mobile']; ?>" class="form-control" placeholder="Phone" required />
                                </div>
                            </div>
                            <div class="col-md-4 col-sm-12">
                                <div class="form-group">
                                    <input type="text" name="txt8" value="<?php echo $row['faculty_email']; ?>" class="form-control" placeholder="Enter Your Email" required />
                                </div>
                            </div>
                            <div class="col-md-4 col-sm-12">
                                <div class="form-group">
                                    <input type="text" name="txt6" value="<?php echo $row['faculty_designation']; ?>" class="form-control" placeholder="Designation" required />
                                </div>
                            </div>
                            ...
                            <div class="col-lg-12 col-md-12 col-sm-12">
                                <!--<form action="https://thememakker.com/" id="frmFileUpload" class="dropzone" method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="fallback">
                                        <input name="file" type="file" name="txt9" value="<?php echo $row['faculty_photo']; ?>" multiple required />
                                    </div>
                                </form>
                            </div>
                            <div class="col-sm-12">
                                <div class="form-group">
                                    <textarea rows="4" name="txt10" value="<?php echo $row['faculty_address']; ?>" class="form-control no-resize" placeholder="Address" required /></textarea>
                                </div>
                            </div>
                            <div class="col-md-6 col-sm-12">
                                <div class="form-group">
                                    <input type="text" name="txt11" value="<?php echo $row['faculty_password']; ?>" class="form-control" placeholder="Password">
                                </div>
                            </div>
                            <div class="col-sm-12">
                                <div class="row clearfix">
