                        ...
                        <div class="row clearfix">
                            <div class="col-sm-12">
                                <div class="form-group">
                                    <input type="text" name="txt1" class="form-control" placeholder="Department Name " required />
                                </div>
                            </div>
                            <div class="col-sm-12">
                                <div class="form-group">
                                    <input type="text" name="txt2" class="form-control" placeholder="course name " required />
                                </div>
                            </div>
                        </div>
                        <!--<div class="row clearfix">
