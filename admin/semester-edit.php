...
$fetchq = mysqli_query($connection, "select * from tbl_semester where sem_id='{$id}'") or die(mysqli_error($connection));
$row = mysqli_fetch_array($fetchq);
if($_POST)
{
    $name = $_POST['txt1'];
    mysqli_query($connection, "update tbl_semester set semester_name='{$name}' where student_id='{$_GET['eid']}'");
...
if($_POST){
    ...
    $q = mysqli_query($connection, "insert into tbl_semester (sem_name) values('{$name}')") or die(mysqli_error($connection));
    ...
    <div class="container-fluid">
        <div class="row clearfix">
            <div class="col-lg-12 col-md-12 col-sm-12">
                <div class="card">
                    <div class="header">
                        <h2><strong>Semester </strong> Information </h2>
                        ...
                        <div class="row clearfix">
                            <!--<div class="col-sm-12">
                                <div class="form-group">
                                    <input type="text" class="form-control" placeholder="Semester Id">
                                </div>
                            </div>-->
                            <div class="col-sm-12">
                                <div class="form-group">
                                    <input type="text" name="txt1" value="<?php echo $row['sem_name']; ?>" class="form-control" placeholder="Semester Number" required />
                                </div>
                            </div>
