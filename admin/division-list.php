...
<!-- Mirrored from thememakker.com/templates/oreo/university/html/departments.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 27 Dec 2021 05:01:29 GMT -->
<head>
<meta charset="utf-8">
        ...
        <div class="row">
            ...
            <div class="col-lg-5 col-md-7 col-sm-12">                
                ...
                <ul class="breadcrumb float-md-right">
                    ...
                    <li class="breadcrumb-item"><a href="departments.php">Division</a></li>
    ...
    <div class="container-fluid">
        <div class="row clearfix">
            <div class="col-lg-12 col-md-12">                
                <div class="card">
                    <div class="header">
                        <h2><strong>All</strong> Division List</h2>
                    ...
                    <div class="body table-responsive">
                        <table class='table table-hover m-b-0'>
                            ...
                            <?php
                                    ...
                                    //Delete Start
                                    if(isset($_GET['did'])){
                                        $q =  mysqli_query($connection, "delete from tbl_division where division_id='{$_GET['did']}'") or die(mysqli_error($connection));
                                            if($q){
                                    ...
                                    while($data = mysqli_fetch_array($q)){
                                        echo "<tr>";
                                        echo "<td>{$data['division_id']}</td>";
                                        echo "<td>{$data['division_name']}</td>";                                        
                                        echo "<td><a href='division-edit.php?eid={$data['division_id']}'>Edit</a> | <a href='division-list.php?did={$data['division_id']}'>Delete</a></td>";
                                        echo "</tr>";
