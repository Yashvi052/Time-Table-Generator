...
$fetchq = mysqli_query($connection, "select * from tbl_division where division_id='{$id}'") or die(mysqli_error($connection));
$row = mysqli_fetch_array($fetchq);
if($_POST)
{
    $name = $_POST['txt1'];
    mysqli_query($connection, "update tbl_division set division_name='{$name}' where division_id='{$_GET['eid']}'");
...
if($_POST){
    ...
    $q = mysqli_query($connection, "insert into tbl_division (division_name) "
            . "values('{$name}')") 
    ...
    <div class="container-fluid">
        <div class="row clearfix">
            <div class="col-lg-12 col-md-12 col-sm-12">
                <div class="card">
                    <div class="header">
                        <h2><strong>Division </strong> Information </h2>
                    ...
                    <div class="body">
                        <div class="row clearfix">
                            ...
                            <div class="col-sm-12">
                                <div class="form-group">
                                    <input type="text" name="txt1" value="<?php echo $row['division_name']; ?>" class="form-control" placeholder=" Division" required />
                                </div>
                            </div>
