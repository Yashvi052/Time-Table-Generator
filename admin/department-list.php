                        ...
                        <table class='table table-hover m-b-0'>
                            ...
                            <tbody>
                                <?php
                                    ...
                                    //Delete Start
                                    if(isset($_GET['did'])){
                                        $q =  mysqli_query($connection, "delete from tbl_department where department_id='{$_GET['did']}'") or die(mysqli_error($connection));
                                            if($q){
                                    ...
                                    while($data = mysqli_fetch_array($q)){
                                        ...
                                        echo "<td>{$data['department_course']}</td>";                                        
                                        echo "<td><a href='department-edit.php?eid={$data['department_id']}'>Edit</a> | <a href='department-list.php?did={$data['department_id']}'>Delete</a></td>";
                                        echo "</tr>";
