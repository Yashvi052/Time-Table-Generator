    ...
    <div class="container-fluid">
        <div class="row clearfix">
            <div class="col-lg-12 col-md-12">                
                <div class="card">
                    <div class="header">
                        <h2><strong>All</strong> Semester List</h2>
                        ...
                        <table class='table table-hover m-b-0'>
                            ...
                            <tbody>
                                <?php
                                    ...
                                    //Delete Start
                                    if(isset($_GET['did'])){
                                        $q =  mysqli_query($connection, "delete from tbl_semester where sem_id='{$_GET['did']}'") or die(mysqli_error($connection));
                                            if($q){
                                    ...
                                    while($data = mysqli_fetch_array($q)){
                                        echo "<tr>";
                                        echo "<td>{$data['sem_id']}</td>";
                                        echo "<td>{$data['sem_name']}</td>";                                        
                                        echo "<td><a href='semester-edit.php?eid={$data['sem_id']}'>Edit</a> | <a href='semester-list.php?did={$data['sem_id']}'>Delete</a></td>";
                                        echo "</tr>";
