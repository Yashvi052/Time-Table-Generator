...
if(isset($_POST['btn'])){
    ...
    $q = mysqli_query($connection, "insert into tbl_admin (admin_name, admin_email, admin_password) values('{$name}','{$email}','{$password}')") or die(mysqli_error($connection));
    ...
    <div class="container-fluid">
        <div class="row clearfix">
            <div class="col-lg-12 col-md-12 col-sm-12">
                <div class="card">
                    <div class="header">
                        <h2><strong>Admin</strong> Information  </h2>
                    ...
                    <div class="body">
                        ...
                        <div class="row clearfix">
                            <div class="col-lg-6 col-md-12">
                                <div class="form-group">
                                    <input type="text" name="txt2" class="form-control" placeholder="Enter Email" required />
                                </div>
                            </div>
