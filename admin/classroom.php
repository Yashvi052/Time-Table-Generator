...
<!-- Mirrored from thememakker.com/templates/oreo/university/html/classroom.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 27 Dec 2021 05:01:31 GMT -->
<head>
<meta charset="utf-8">
    ...
    <ul class="nav navbar-nav navbar-left">
        <li>
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="index.php><img src="assets/images/logo.svg" width="30" alt="Oreo"><span class="m-l-10">Oreo</span></a>
            </div>
        </li>
        <li><a href="javascript:void(0);" class="ls-toggle-btn" data-close="true"><i class="zmdi zmdi-swap"></i></a></li>
        <li><a href="events.php" title="Events"><i class="zmdi zmdi-calendar"></i></a></li>
        ...
        <li class="float-right">
            ...
            <a href="sign-in.php" class="mega-menu" data-close="true"><i class="zmdi zmdi-power"></i></a>
        ...
        <div class="tab-pane stretchRight active" id="dashboard">
            <div class="menu">
                <ul class="list">
                    <li>
                        <div class="user-info">
                            <div class="image"><a href="profile.php"><img src="assets/images/profile_av.jpg" alt="User"></a></div>
                            <div class="detail">
                                <h4>Pro. Charlotte</h4>
                    ...
                    <li><a href="events.php"><i class="zmdi zmdi-calendar-check"></i><span>Events</span> </a></li>
                    ...
                    <li class="active open"><a href="classroom.php"><i class="zmdi zmdi-device-hub"></i><span>Class</span> </a></li>
                    ...
                    <li><a href="javascript:void(0);" class="menu-toggle"><i class="zmdi zmdi-folder"></i><span>File Manager</span> </a>
                        <ul class="ml-menu">
                            <li><a href="file-dashboard.php">All File</a></li>
