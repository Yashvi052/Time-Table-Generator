...
if($_POST)
{
    ...
    $oldpasswordquery = mysqli_query($connection, "select student_password from tbl_student where student_id='{$_SESSION['studentid']}'") or die(mysqli_error($connection));
    $oldpasswordfromdb = mysqli_fetch_array($oldpasswordquery);
    //Old Password Condition
    if($oldpasswordfromdb['student_password'] == $opass)
    {
       ...
       if($npass == $cpass)
       {
         ...
         {
             $updateq = mysqli_query($connection, "update tbl_student set student_password='{$npass}' where student_id='{$_SESSION['studentid']}'") or die(mysqli_error($connection));
             if($updateq)
             {
...
<nav class="navbar navbar-expand-lg fixed-top navbar-transparent">
    <div class="container">        
        ...
        <div class="navbar-collapse">
            <ul class="navbar-nav">
                <li class="nav-item">
                    <a class="nav-link" href="http://localhost/automated_timetable_generator/index.php">Home</a>
                </li>
                <!--<li class="nav-item">
                ...
                <li class="nav-item">
                    <a class="nav-link btn btn-white btn-round" href="http://localhost/automated_timetable_generator/sign-in.php">SIGN IN</a>
                </li>
            </ul>
        </div>
    </div>
