...
if($_POST)
{
    ...
    $oldpasswordquery = mysqli_query($connection, "select st_password from tbl_student where st_id='{$_SESSION['studentid']}'") or die(mysqli_error($connection));
    ...
    if($oldpasswordfromdb['student_password'] == $opass)
    {
       ...
       if($npass == $cpass)
       {
         ...
         {
             $updateq = mysqli_query($connection, "update tbl_student set student_password='{$npass}' where st_id='{$_SESSION['studentid']}'") or die(mysqli_error($connection));
             if($updateq)
             {
