...
if($_POST)
{
    ...
    $selectquery = mysqli_query($connection, "select * from tbl_student where student_email='{$email}'") or die(mysqli_error($connection));
    ...
    if($count>0)
    {
        ...
        try {
            ...
            $mail->Body    = "Hi $email your passowrd is {$row['student_password']}";
            $mail->AltBody = "Hi $email your passowrd is {$row['student_password']}";
...
<meta charset="utf-8">
    ...
    <title>:: GLS University User ::</title>
    <!-- Favicon-->
