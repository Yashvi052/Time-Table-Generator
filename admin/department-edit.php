...
$fetchq = mysqli_query($connection, "select * from tbl_department where department_id='{$id}'") or die(mysqli_error($connection));
$row = mysqli_fetch_array($fetchq);
if($_POST)
{
    $name = $_POST['txt1'];
    $course = $_POST['txt2'];
    mysqli_query($connection, "update tbl_semester set department_name='{$name}',department_course='{$course}' where department_id='{$_GET['eid']}'");
...
<!-- Mirrored from thememakker.com/templates/oreo/university/html/add-departments.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 27 Dec 2021 05:01:29 GMT -->
<head>
<meta charset="utf-8">
...
if($_POST){
    ...
    $q = mysqli_query($connection, "insert into tbl_department (department_name, department_course) values('{$name}','{$course}')") or die(mysqli_error($connection));
    ...
    <div class="container-fluid">
        <div class="row clearfix">
            <div class="col-lg-12 col-md-12">                
                <div class="card">
                    <div class="header">
                        <h2><strong>Department</strong> Basic Info </h2>
                        ...
                        <div class="row clearfix">
                            <div class="col-sm-12">
                                <div class="form-group">
                                    <input type="text" name="txt1" value="<?php echo $row['department_name']; ?>" class="form-control" placeholder="Department Name " required />
                                </div>
                            </div>
                            <div class="col-sm-12">
                                <div class="form-group">
                                    <input type="text" name="txt2" value="<?php echo $row['department_course']; ?>" class="form-control" placeholder="course name " required />
                                </div>
                            </div>
                        </div>
                        <!--<div class="row clearfix">
                            <div class="col-sm-12">
                                <div class="form-group">
                                    <input type="number" class="form-control" placeholder="No. of Students " required>
                                </div>
                            </div>
                        </div>-->
                        <div class="row clearfix">                            
                            <!--<div class="col-sm-12">
                                <div class="form-group">
                                    <textarea rows="4" class="form-control no-resize" placeholder="Brief" required></textarea>
                                </div>
                            </div>-->
                            <div class="col-sm-12">
