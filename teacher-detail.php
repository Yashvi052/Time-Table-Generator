...
<!-- Mirrored from thememakker.com/templates/oreo/university/front/teacher-detail.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 27 Dec 2021 05:04:44 GMT -->
<head>
<meta charset="UTF-8">
<meta name="viewport" content="width=device-width, initial-scale=1.0">
<meta http-equiv="X-UA-Compatible" content="ie=edge">
<title>:: GLS University :: Teachers Details</title>
...
<div class="wrapper">
            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-5 col-sm-5">
                        <a href="index.php" class="navbar-brand"><img src="assets/images/logo.svg"alt="logo"></a>
                    </div>
                        ...
                        <ul class="navbar-nav mr-auto">
                            ...
                            <!--<li class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                                    ...
                                    <a class="dropdown-item" href="galary.html">Galary</a>
    ...
    <section id="hero">
        <div class="inner-banner" style="background-image:url(assets/images/banner-teachers.jpg)">
            <div class="container">
                <h3 class="title">About<br><big><strong> Teachers</strong></big></h3>
            </div>
        </div>
    </section>
    ...
    <section class="main-section our-team-page">
        ...
        <!-- Our Team -->
        <div class="our-team our-teacher section-65-100">
            <div class="container">
                <div class="row justify-content-between">
                    <div class="section-title col-lg-5">
                        <h2><span>Pro. </span>Charlotte Deo</h2>
                ...
                <div class="row justify-content-between">
                    <div class="col-lg-4 col-md-5 col-sm-12">
                        <div class="box-img box-shadow">
                            <img src="assets/images/teacher-img-01.jpg" alt="">
                            <span class="section-line"></span>
                        </div>
                    </div>
                    <div class="col-lg-7 col-md-7 col-sm-12">
                        <div class="teacher-info">
                            <ul class="list-unstyled clearfix teacher-contact">
                                <li class="float-left"><i class="zmdi zmdi-email"></i>Info@info.com</li>
                                <li class="float-left"><i class="zmdi zmdi-calendar"></i>01 Jan, 2016</li>
                                <li class="float-left"><i class="zmdi zmdi-phone"></i>+ (02) 132 456 7989</li>
                            </ul>
                            <p>Charlotte Deo Leon is a neurosurgeon in East Patchogue,Contrary to popular belief, Lorem
                                Ipsum is not simply random text. It has roots in a piece of classical Latin literature
                                from 45 BC, making it over 2000 years old. He received his medical degree from Harvard
                                Medical School and has been in practice for 21 years. He is one of 5 doctors at
                                Brookhaven.</p>
                            ...
                            <div class="skill-grp">
                                ...
                                <ul class="list-unstyled">
                                    <li>
                                        <label>French</label>
                                        <div class="progress">
                                            <div class="progress-bar bg-indigo" role="progressbar" style="width: 80%" aria-valuenow="80" aria-valuemin="0" aria-valuemax="100"></div>
                                        </div>
                                    </li>
                                    <li>
                                        <label>Computer</label>
                                        <div class="progress">
                                            <div class="progress-bar bg-light-blue" role="progressbar" style="width: 30%" aria-valuenow="30" aria-valuemin="0" aria-valuemax="100"></div>
                                        </div>
                                    </li>
                                    <li>
                                        <label>Art</label>
                                        <div class="progress">
                                            <div class="progress-bar bg-deep-orange" role="progressbar" style="width: 50%" aria-valuenow="50" aria-valuemin="0" aria-valuemax="100"></div>
                                        </div>
                                    </li>
                                    <li>
                                        <label>Science</label>
                                        <div class="progress">
                                            <div class="progress-bar bg-amber" role="progressbar" style="width: 88%" aria-valuenow="88" aria-valuemin="0" aria-valuemax="100"></div>
                                        </div>
                                    </li>
                                </ul>
                            </div>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-6 col-md-6">
                        <small>Copyright &copy; 2018 GLS Theme by <a href="http://thememakker.com/" target="_blank">ThemeMakker</a> </small> </div>
