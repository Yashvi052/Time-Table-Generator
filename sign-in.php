...
if ($_POST) {
    ...
    $selectquery = mysqli_query($connection, "select * from tbl_student where student_email='{$email}' and student_password='{$password}'") or die(mysqli_error($connection));
    ...
    <nav class="navbar navbar-expand-lg fixed-top navbar-transparent">
        <div class="container">
            <div class="navbar-translate n_logo">
                <a class="navbar-brand" href="javascript:void(0);" title="" target="_blank">GLS</br>STUDENT LOGIN</a>
                ...
                <div class="card-plain">
                    <form class="form" method="post" action="#" id="myform">
                        ...
                        <div class="footer text-center">
                            ...
                            <h5><a href="http://localhost/automated_timetable_generator/admin/forgot-password.php" class="link">Forgot Password?</a></h5>
                            <!--<h5><a href="change-password1.php" class="link">Change Password?</a></h5>-->
                        </div>
                    </form>
                </div>
            </div>
